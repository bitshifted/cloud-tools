...
| <a name="input_repo_lifecycle_policy_path"></a> [repo\_lifecycle\_policy\_path](#input\_repo\_lifecycle\_policy\_path) | Path to JSON  file providing lifecycle policy for the repository | `string` | `null` | no |
